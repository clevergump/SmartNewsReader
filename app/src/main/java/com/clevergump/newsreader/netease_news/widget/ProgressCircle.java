package com.clevergump.newsreader.netease_news.widget;
...
import com.clevergump.newsreader.netease_news.utils.DensityUtils;
...
public class ProgressCircle extends View {
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i=0; i< indexCount; i++) {
            ...
            switch (index) {
                case R.styleable.ProgressCircle_circleBorderColor:
                    mCircleBorderColor = a.getColor(index, DEF_CIRCLE_BORDER_COLOR);
                    break;
                case R.styleable.ProgressCircle_circleBorderWidth:
                    ...
                    break;
                case R.styleable.ProgressCircle_circleOuterRadius:
                    mCircleOuterRadius = a.getDimension(index, mCircleOuterRadius);
                    break;
                case R.styleable.ProgressCircle_innerPieColor:
                    mInnerPieColor = a.getColor(index, DEF_INNER_PIE_COLOR);
                    break;
                case R.styleable.ProgressCircle_innerPieMaxProgress:
                    ...
                    break;
                case R.styleable.ProgressCircle_innerPieProgress:
                    mInnerPieProgress = a.getInt(index, DEF_PROGRESS);
                    break;
                case R.styleable.ProgressCircle_innerPieStartingAngle:
